 ...
 *   id = "payment_process_drupaldev",
 *   label = @Translation("Payment process (Drupaldev)"),
...
class PaymentProcess extends CheckoutPaneBase {
  ...
  public function isVisible() {
    ...
    $payment_info_pane = $this->checkoutFlow->getPane('billing_profile');
  ...
  protected function getErrorStepId() {
    ...
    $step_id = $this->checkoutFlow->getPane('billing_profile')->getStepId();
    if ($step_id == '_disabled') {
      ...
      throw new \RuntimeException('Cannot get the step ID for the billing_profile pane. The pane is disabled.');
    }
