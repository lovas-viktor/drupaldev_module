...
namespace Drupal\drupaldev_commerce\Plugin\Commerce\Condition;
 ...
 *
 * @CommerceCondition(
 *   id = "order_total_price_additional",
 *   label = @Translation("Total price additional"),
 *   display_label = @Translation("Current order total additional"),
 *   category = @Translation("Order", context = "Commerce"),
 *   entity_type = "commerce_order",
 * )
 */
class OrderTotalPriceAdditional extends ConditionBase {
