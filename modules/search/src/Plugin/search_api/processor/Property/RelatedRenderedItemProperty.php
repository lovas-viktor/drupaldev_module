...
namespace Drupal\drupaldev_search\Plugin\search_api\processor\Property;
 ...
 */
class RelatedRenderedItemProperty extends ConfigurablePropertyBase {
  ...
  public function buildConfigurationForm(FieldInterface $field, array $form, FormStateInterface $form_state) {
    ...
    $form['item_number'] = [
      ...
      '#default_value' => $configuration['item_number'],
      '#required' => TRUE,
    ];
