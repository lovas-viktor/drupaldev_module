        ...
        if ($(target).find('.slinky-menu--mobile')) {
          if (windowsize < 768) {
            $(".slinky-menu--mobile").once('slinkyOnce').each(function () {
              ...
              $('.slinky-menu li.menu-item--expanded').each(function () {
                $(this).children().children().children().children('.menu-title').click(function(){
                  $('.slinky-theme-default').addClass('slinky-linkable')
